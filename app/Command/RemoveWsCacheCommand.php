...
class RemoveWsCacheCommand extends HyperfCommand
{
    ...
    public function handle()
    {
        ...
        // 获取所有已停止运行的服务ID
        $arr = ServerRunID::getInstance()->getShutDwonServerRunId();
    ...
    public function clear(string $run_id)
    {
        ...
        SocketFdBindImei::getInstance()->delete($run_id);

        $prefix   = SocketImeiBindFds::getInstance()->getCachePrefix($run_id);
        $iterator = null;
        while (true) {
